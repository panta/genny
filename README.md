...
This is a fork of the original [github.com/cheekybits/genny](github.com/cheekybits/genny), that adds the `-ignore-imports` command-line flag.

Install:

```
go get github.com/panta/genny
```
...
Flags:
  ...
  -ignore-imports=true: don't process imports (sometimes they are processed with incorrect results)
```
...
To see a real example of how to use `genny` with `go generate`, look in the [example/go-generate directory](https://github.com/panta/genny/tree/master/examples/go-generate).
...
Given [this generic Go code](https://github.com/panta/genny/tree/master/examples/queue) which compiles and is tested:
...
// see https://github.com/panta/genny
...
Check out the [test code files](https://github.com/panta/genny/tree/master/parse/test) for more real examples.
...
### Contributions
  ...
  * See the [API documentation for the parse package](http://godoc.org/github.com/panta/genny/parse)
  * Please do TDD
  * All input welcome
